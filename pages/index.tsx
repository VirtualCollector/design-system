...
import { Table, Caption, Thead, Tbody, Tfoot, Tr, Th, Td } from '../primitives/Table';
...
import { Sup } from '../primitives/Sup';
import { Sub } from '../primitives/Sub';
import { TextField } from '../primitives/TextField';
import { Section } from '../primitives/Section';
import { Avatar } from '../primitives/Avatar';
import { TabLink } from '../primitives/TabLink';
import { SimpleToggle } from '../primitives/SimpleToggle';
...
import { Sheet, SheetTrigger, SheetContent } from '../primitives/Sheet';
...
import { RadioCardGroup, RadioCard } from '../primitives/RadioCard';
import {
  Accordion,
  AccordionTrigger,
  AccordionItem,
    ...
    <Box>
      ...
      <Banner id="banner" variant="blue" rounded>
        ...
        <Text size="2" css={{ fontWeight: 500 }}>
          VirtualCollector raises a $15M Series A.
        </Text>
          ...
          <Container size="3">
            ...
            <Flex css={{ gap: '$3' }}>
              <Box css={{ width: 250 }}>
                <Card css={{ p: '$3' }}>
                  <Heading css={{ mb: '$2' }}>
                    VirtualCollector raises $4.2M to close the gap between design and code
                  </Heading>
                  <Text size="3" css={{ color: '$slate11', lineHeight: '23px' }}>
                    VirtualCollector is a visual code editor that empowers teams to design, develop, document
              ...
              <Box css={{ width: 250 }}>
                <Card as="button" variant="active" css={{ p: '$3' }}>
                  ...
                  <Text size="3" css={{ color: '$slate11', lineHeight: '23px' }}>
                    VirtualCollector is a visual code.
                  </Text>
                </Card>
              </Box>
            </Flex>
