...
import { TitleAndMetaTags } from '../primitives/TitleAndMetaTags';
...
export default function Home() {
  ...
  return (
    <Box>
      <TitleAndMetaTags title="VirtualCollector" />
      <Box
        css={{
          top: 0,
          right: 0,
          ...
          zIndex: '-1',
          background:
            'radial-gradient(circle at top left, $green4, rgba(255, 255, 255, 0) 15%), radial-gradient(circle at 80% 20%, $cyan4, rgba(255, 255, 255, 0) 15%)',
          '@bp2': {
            background:
              'radial-gradient(circle at 15% 50%, $green4, rgba(255, 255, 255, 0) 25%), radial-gradient(circle at 85% 30%, $cyan4, rgba(255, 255, 255, 0) 25%)',
          },
        }}
      />
          ...
          >
            <Box>
              ...
              <Text size="4" css={{ lineHeight: '27px', '@bp2': { mb: '$6' } }}>
                Variants are a first-class citizen of VirtualCollector. With multiple variants, compound
            ...
            <Box>
              ...
              <Text size="4" css={{ lineHeight: '27px', '@bp2': { mb: '$6' } }}>
                VirtualCollector has built-in solutions for tokens and theming, which use CSS variables
